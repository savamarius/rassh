...
# rassh file system pickle files.
#
...
class fseditCmd(cmd.Cmd):
    ...
    def help_about(self):
        print "Kippo stores information about its file systems in a " + \
            ...
            "stored in a pickle file on the hard drive. Every time rassh " + \
            "gets a new client, it reads from the pickle file and loads " + \
            "the fake filesystem into memory. By default this file " + \
            "is /opt/rassh/fs.pickle. Originally the script " + \
            "/opt/rassh/createfs.py was used to copy the filesystem " + \
            ...
            "rassh process in order for the new file system to be " + \
