...
if os.name == 'posix' and os.getuid() == 0:
    print 'ERROR: You must not run rassh as root!'
    sys.exit(1)

if not os.path.exists('rassh.cfg'):
    print 'ERROR: rassh.cfg is missing!'
    sys.exit(1)

from rassh.core import honeypot
...
if cfg.has_option('honeypot', 'interact_enabled') and \
    ...
    from rassh.core import interact
